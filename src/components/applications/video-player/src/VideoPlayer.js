...
class VideoPlayer extends React.PureComponent {
  ...
  render() {
    ...
    console.log(this.props.source, 'IIII')
    ...
    return (
      <div
        className={`${
          this.state.hideControlBar || this.state.clickingInside ? 'hidden' : ''
        }`}
        id="video-player"
            ...
            <ControlBar autoHide={true} disableDefaultControls={true}>
              ...
              >
                ...
                >
                  ...
                  {!this.state.muted ? (
                    ...
                    >
                      <img
                        alt=""
                        src={require('../assets/images/speaker.svg').default}
                      />
                    </TopBox>
                  ) : (
                    <TopBox
                    ...
                    >
                      <img
                        alt=""
                        src={require('../assets/images/mute.svg').default}
                      />
                    </TopBox>
                  )}
                </div>
                <div className="top-right-controls">
                  <div
                    className="control-item"
                    onClick={() => this.setState({ isSpeed: true })}
                  >
                  ...
                  <div className="control-item" onClick={() => this.goFull()}>
                    ...
                    <TopBox className="full icon-selected">
                      {!this.state.isFull ? (
                        <img
                          alt=""
                          src={require('../assets/images/max.svg').default}
                        />
                      ) : (
                        <img
                          alt=""
                          src={require('../assets/images/mini.svg').default}
                        />
                      )}
                    </TopBox>
                  </div>
              ...
              {this.state.quality.length > 0 && (
                <SoundContainer
                  ...
                  onClick={() => this.setState({ isQuality: false })}
                >
                  <SoundHeaderContainer
              ...
              >
                <ControlIcon onClick={this.changeCurrentTime(-10)}>
                  <img
                    alt="Icon"
                    src={require('../assets/images/backward.svg').default}
                  />
                </ControlIcon>
